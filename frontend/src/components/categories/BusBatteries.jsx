      ...
      {!error && (
        <div className="filters-section">
          ...
          <select value={price} onChange={e => setPrice(e.target.value)} id="filters">
            ...
            <option value="low" id="filter-option">Low (&lt; 35k)</option>
            <option value="medium" id="filter-option">Medium (35k–40k)</option>
            <option value="high" id="filter-option">High (&gt; 40k)</option>
          </select>
        </div>
        ...
        <>
          <div className="grid">
            {loading ? (
              ...
              <p className='message'>No bus batteries found.</p>
            )}
          </div>
