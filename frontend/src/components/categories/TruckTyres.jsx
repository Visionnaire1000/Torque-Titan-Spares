      ...
      {!error && (
        <div className="filters-section">
          ...
          <select value={price} onChange={e => setPrice(e.target.value)} id="filters">
            ...
            <option value="medium" id="filter-option">Medium (35k–45k)</option>
            <option value="high" id="filter-option">High (&gt; 45k)</option>
          </select>
        </div>
      )}
        ...
        <>
          ...
          <div className="grid">
            {loading ? (
              ...
              <p className='message'>No Truck tyres found.</p>
            )}
          </div>
          ...
          {loading ? (
            <div className="pagination skeleton-pagination">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="skeleton-page-btn" />
              ))}
            </div>
          ) : totalPages > 1 && (
