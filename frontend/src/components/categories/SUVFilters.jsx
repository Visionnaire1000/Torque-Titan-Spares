...
const ErrorState = ({ onRetry }) => (
  <div className="error-state">
    <h2>Failed to load SUV filters</h2>
...
const SUVFilters = () => {
  ...
  const availableBrands = [
    'Bosch', 'K&N', 'Fram', 'Mann', 'AC Delco', 'Motorcraft', 'Purolator'
  ];
  ...
  const fetchFilters = async () => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Failed to fetch SUV filters");
          ...
          <div className="grid">
            {loading
              ...
              : items.length
                ...
                : <p className='message'>No SUV filters found.</p>
            }
          </div>
