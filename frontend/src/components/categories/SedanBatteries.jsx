      ...
      {!error && (
        <div className="filters-section">
          ...
          <select value={price} onChange={e => setPrice(e.target.value)} id="filters">
            ...
            <option value="low" id="filter-option">Low (&lt; 20k)</option>
            <option value="medium" id="filter-option">Medium (20k–30k)</option>
        ...
        <>
          <div className="grid">
            {loading ? (
              ...
              <p className='message'>No sedan batteries found.</p>
            )}
          </div>
